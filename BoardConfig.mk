...
LOCAL_PATH := device/oukitel/mandarin

# inherit from the proprietary version
-include vendor/oukitel/mandarin/BoardConfigVendor.mk
...
BOARD_CUSTOM_BOOTIMG_MK := device/oukitel/mandarin/mkbootimg.mk
...
TARGET_PREBUILT_KERNEL := device/oukitel/mandarin/prebuilt/kernel

#system.prop
TARGET_SYSTEM_PROP := device/oukitel/mandarin/system.prop

# CMHW
BOARD_HARDWARE_CLASS := device/oukitel/mandarin/cmhw/
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/oukitel/mandarin/bluetooth
...
#recovery
TARGET_RECOVERY_FSTAB := device/oukitel/mandarin/recovery/root/etc/twrp.fstab
...
BOARD_EGL_CFG := device/oukitel/mandarin/configs/egl.cfg
...
# SELinux
BOARD_SEPOLICY_DIRS := \
       device/oukitel/mandarin/sepolicy
